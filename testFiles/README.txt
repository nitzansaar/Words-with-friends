...
redirection. Because of that, the .out files do not show the rack
...
output for the rack that was in the corresponding .in file.
...
* The files here:
   ...
   duplicate.txt -- a dictionary that has a duplicate word
   duplicate.in -- sample input for duplicate dictionary
   duplicate.out -- corresponding output for duplicate.txt run with duplicate.in
